...
public class DContent_Constraints extends BaseConstraintsDescriptor {
  public DContent_Constraints() {
    super(CONCEPTS.DContent$FU);
  }
  ...
  public static class Name_Property extends BasePropertyConstraintsDescriptor {
    ...
    public boolean validateValue(SNode node, Object propertyValue, CheckingNodeContext checkingNodeContext) {
      ...
      if (!(result) && checkingNodeContext != null) {
        checkingNodeContext.setBreakingNode(new SNodePointer("r:43f481fb-cbe1-4275-a430-6cfce1240c9a(Glot.constraints)", "2362249378868134808"));
      }
      return result;
    }
